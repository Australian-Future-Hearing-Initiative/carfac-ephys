...
Fitted scale factor: 0.03162 uV/AU, matching the Control response at 80 dB SPL to the pre-exposure chinchilla click Wave-I amplitude (Bharadwaj et al. 2022).
...
- **Click Threshold Preservation vs Animals**: PASSED
  - Simulated threshold shift is within 3 dB of the measured chinchilla shift.
- **Suprathreshold Wave-I Attenuation vs Animals**: PASSED
  - Simulated post/pre Wave-I ratio is within 0.1 of the measured chinchilla ratio.
...
The Selective-Synaptopathy cohort stands in for the noise-exposed chinchillas of
...
| --- | --- | --- | --- | --- |
| Click ABR threshold shift (dB) | +0.23 | -0.30 | +/-3 dB | PASSED |
| Suprathreshold Wave-I post/pre ratio (80 dB SPL) | 0.691 | 0.742 | +/-0.1 | PASSED |
